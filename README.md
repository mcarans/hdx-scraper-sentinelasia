# Collector for Sentinelasia Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-sentinelasia/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-sentinelasia/actions/workflows/run-python-tests.yaml)
[![Coverage Status](https://coveralls.io/repos/github/OCHA-DAP/hdx-scraper-sentinelasia/badge.svg?branch=main&ts=1)](https://coveralls.io/github/OCHA-DAP/hdx-scraper-sentinelasia?branch=main)
 ...
 **hdx-scraper-sentinelasia** as specified in the parameter
 *user_agent_lookup*.
...
```shell
    pip install .
    python -m hdx.scraper.sentinelasia
```
